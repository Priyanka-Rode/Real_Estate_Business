...
body{
	 background-image:url(https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQeHVSUbhk4P0xwE242yJkGva5i4Ire5TEbMnNaauZfWGj83FouyHppUr9fel64rvzYWEV4GoZKErQ&usqp=CAU&ec=48665701);
...
<div class="container">
 <!---heading---->
     <header class="heading">PROPERTY BUYER DETIALS</header><hr></hr>
	<!---Form starting----> 
	<div class="row ">
	 <!--- For Name---->
         <div class="col-sm-12">
             <div class="row">
			     <div class="col-xs-4">
          	         <label class="firstname">Buyer First Name :</label> </div>
		         <div class="col-xs-8">
         ...
         <div class="col-sm-12">
		     <div class="row">
			     <div class="col-xs-4">
                     <label class="lastname">Buyer Last Name:</label></div>
				<div class ="col-xs-8">	 
		 ...
		 <div class="col-sm-12">
		     <div class="row">
			     <div class="col-xs-4">
                     <label class="phoneumber">Phone Number :</label></div>
				<div class ="col-xs-8">	 
