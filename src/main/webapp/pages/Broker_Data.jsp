...
<style>@import url("https://fonts.googleapis.com/css?family=Lato:400,700&display=swap");
...
<body>
<form action="Add_Broker" method="post">
...
<section class="page-content">
  ...
  <button type="submit" class="btn btn-outline-primary btn-sm pull-right">ADD BROKER</button> 
   </form>
   
   <center>
<h1>Broker Data</h1><br>
<table border="3px" width="1200px";>
<tr>
<th>Id</th>
<th>First Name</th>
<th>Last Name</th>
...
<td>${e.date}</td>
<td>
<a href="broker_edit?id=${e.id}">Edit</a>&nbsp &nbsp &nbsp
<a href="broker_del?id=${e.id}">Delete</a>
